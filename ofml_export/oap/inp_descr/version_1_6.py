...
EBase configuration file for OAP version 1.6.
end comment 

table oap_action oap_action.csv mscsv
fields  5
field   1	action			vstring		delim ; trim hidx
field   2	condition		vstring		delim ; trim
field   3	type			vstring		delim ; trim
field   4	parameter		vstring		delim ; trim
field   5	objects			vstring		delim ; trim

table oap_actionchoice oap_actionchoice.csv mscsv
fields  5
field   1	id			vstring		delim ; trim hidx
field   2	title			vstring		delim ; trim
field   3	view_type		vstring		delim ; trim
field   4	argument		vstring		delim ; trim
field   5	list_id			vstring		delim ; trim
